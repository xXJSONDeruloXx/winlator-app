...
public abstract class WindowRequests {
    ...
    public static void getGeometry(XClient client, XInputStream inputStream, XOutputStream outputStream) throws IOException, XRequestError {
        ...
        // GetGeometry accepts both ordinary drawables and windows. InputOnly
        // windows deliberately have no pixel backing store, but they still
        // have a valid geometry and are queried by X11 input/IM clients.
        // Treat the window resource as authoritative when present and use a
        // zero depth for InputOnly, as required by the core protocol.
        ...
        byte depth = window != null && window.isInputOutput()
            ...
            : (drawable != null ? drawable.visual.depth : 0);
